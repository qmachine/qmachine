...
[CouchDB](http://couchdb.apache.org/). I have also written a "port" to Node.js
that uses [SQLite](http://www.sqlite.org/) as a persistent storage mechanism. I
am currently writing several papers about Quanah and Qmachine, but I promise I
will write more documentation soon!
